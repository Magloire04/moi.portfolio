...
const INTRO = {
  fr: 'Ce que TECHNUM livre concrètement, à travers les compétences appliquées sur les projets présentés dans le portfolio.',
  en: 'What TECHNUM actually delivers, through the skills applied across the projects shown in this portfolio.',
};
